...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "pin_code_error_subtitle": MessageLookupByLibrary.simpleMessage(
            "Вы неверно повторили код 2 раза подряд. Вы можете придумать новый код, чтобы при каждом входе в приложение не вводить логин и пароль, или пропустить этот шаг."),
