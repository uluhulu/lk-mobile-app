...
class RestorePasswordEnterTextField extends StatefulWidget {
  ...
  @override
  State<RestorePasswordEnterTextField> createState() =>
      _RestorePasswordEnterTextFieldState();
}

class _RestorePasswordEnterTextFieldState
    extends State<RestorePasswordEnterTextField> {
  @override
