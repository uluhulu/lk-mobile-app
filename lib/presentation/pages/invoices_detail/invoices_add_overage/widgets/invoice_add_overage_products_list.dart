...
class InvoiceAddOverageProductsList extends StatelessWidget {
  const InvoiceAddOverageProductsList({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<InvoiceAddOverageBloc, InvoiceAddOverageState>(
      builder: (context, state) {
        // if (state is InvoiceAddOverageLoadingS) {
        //   return const LoadingWidget();
        // }
        if (state is InvoiceAddOverageSearchErrorS) {
  ...
  Widget _itemBuilder(
      BuildContext context, int index, InvoiceAddOverageProductS state) {
    final bloc = context.read<InvoiceAddOverageBloc>();
