...
class InvoiceAddOveragesManufacturerList extends StatelessWidget {
  const InvoiceAddOveragesManufacturerList({
    super.key,
  });
  ...
  void _onChanged(
      BuildContext context, String? newValue, InvoiceAddOverageBloc bloc) {
    if (newValue != null) {
      bloc.manufacturer.value = newValue;
      bloc.add(InvoiceAddOverageFiltersE());
