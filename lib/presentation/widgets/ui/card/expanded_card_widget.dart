...
/// [ExpandedCardWidget] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [ExpandedCardWidget].
///
/// {@tool dartpad}
...
class _ExpandedCardWidgetState extends State<ExpandedCardWidget>
    ...
    return Padding(
      ...
      child: RotationTransition(
        ...
        child: SvgPicture.asset(
          ...
          height: 14,
          color:
              widget.arrowIconColor ?? MyTheme.of(context).primaryButtonColor,
        ),
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    ...
    final widgetOrNull = widget.trailing ?? _buildTrailingIcon(context);
                  ...
                  child: ListTile(
                    ...
                    title: Row(
                      children: [
                        ...
                        if (widgetOrNull != null) widgetOrNull,
                      ],
                    ),
