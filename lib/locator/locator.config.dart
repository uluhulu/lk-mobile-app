...
import '../data/providers/repositories/repository_impl.dart' as _i14;
...
import '../domain/repositories/repository.dart' as _i13;
import '../domain/repositories/user_repository.dart' as _i10;
import '../domain/use_cases/auth/sign_in_use_case.dart' as _i15;
import '../services/appmetrica/appmetrica_service.dart' as _i3;
import '../services/firebase/firebase_service.dart' as _i4;
import '../services/notification/firebase_notification.dart' as _i12;
import '../services/notification/local_notification.dart' as _i6;
import 'locator.dart' as _i16; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i12.FirebaseNotification>(() => _i12.FirebaseNotification(
      localNotification: get<_i6.LocalNotification>()));
  gh.lazySingleton<_i13.Repository>(() => _i14.RepositoryImpl(
        networkInfo: get<_i8.NetworkInfo>(),
        userRepository: get<_i10.UserRepository>(),
      ));
  gh.lazySingleton<_i15.SignInUseCase>(
      () => _i15.SignInUseCase(get<_i10.UserRepository>()));
  return get;
}
